...
void MainWindow::on_doubleSpinBox_valueChanged(double arg1)
{
    ...
    scene->clear();
    drawAxes();
    drawCircle(O,radius,arg1, Qt::magenta);
...
void MainWindow::on_pushButton_Start_CW_clicked()
{
    ui->doubleSpinBox->setValue(360);
    dirCW = true;
    startAnimation();
}

void MainWindow::on_pushButton_Start_CCW_clicked()
{
...
void MainWindow::timerTick()
{
    if(dirCW)
    {
        ...
        {
            ui->doubleSpinBox->setValue(angle - 10);
        }
    }
    else
    {
